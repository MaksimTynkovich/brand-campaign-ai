...
const content = {
  privacy: {
    ...
    body: (
      <>
        <p className="mb-4">
          adPilotsAI соблюдает вашу конфиденциальность. Мы собираем только те данные, которые необходимы для работы сервиса: регистрация, использование продукта и оплата.
        </p>
        <p className="mb-4">
        ...
        <p>
          ...
          <a href="mailto:hello@adpilotsai.com" className="text-primary hover:underline">hello@adpilotsai.com</a>.
        </p>
      </>
    ),
  },
  terms: {
    ...
    body: (
      <>
        <p className="mb-4">
          Используя adPilotsAI, вы соглашаетесь с настоящими условиями. Сервис предоставляется «как есть» для создания рекламного контента с помощью искусственного интеллекта.
        </p>
        <p className="mb-4">
