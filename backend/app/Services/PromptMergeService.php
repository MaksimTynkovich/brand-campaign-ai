            ...
            'messages' => [
                [
                    ...
                    'content' => 'Ты помогаешь объединить шаблонный промпт для генерации рекламного видео с пожеланиями пользователя для VEO3.'
                        . 'Верни один итоговый промпт на английском языке, если есть диалог в промпте, то должен быть на русском: сохрани стиль и структуру шаблона, органично встрой описание продукта/пожелания пользователя. '
